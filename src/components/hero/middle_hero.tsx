...
export default function MiddleHero({ title, image, placeholder }: HeroProps) {
  return (
    <div className="relative h-40 md:h-72 lg:h-80 container mx-auto">
      <Image
        width={1200}
        height={600}
        src={image}
        alt={title ?? "esg hero image"}
        className="h-40 md:h-72 lg:h-80 w-full object-cover rounded-lg absolute"
        priority
      />
